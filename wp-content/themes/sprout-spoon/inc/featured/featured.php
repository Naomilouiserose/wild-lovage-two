	...
	<div class="container">
		...
		<?php
			...
			if($get_featured_posts) {
				...
				$args = array( 'showposts' => 3, 'post_type' => array('post', 'page'), 'post__in' => $featured_posts, 'ignore_sticky_posts' => 1, 'orderby' => 'post__in' );
			} else {
				$args = array( 'cat' => $featured_cat, 'showposts' => 3, 'ignore_sticky_posts' => 1 );
			}
